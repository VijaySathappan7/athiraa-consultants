...
const SectionTitle = ({ eyebrow, title, body, light = false }) => (
  <div className="max-w-xl">
    ...
    <motion.h3
      ...
      whileInView={{ opacity: 1, y: 0 }}
      viewport={{ once: false, amount: 0.6, margin: "-50px" }}
      transition={{ duration: 0.30, delay: 0.35, ease: [0.22, 1, 0.36, 1] }}
    ...
    {body ? (
      <motion.p
        ...
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: false, amount: 0.6, margin: "-50px" }}
        transition={{ duration: 0.30, delay: 0.42, ease: [0.22, 1, 0.36, 1] }}
      ...
      {open && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 overflow-hidden">
          ...
          <motion.div
            ...
            transition={{ duration: 0.30, ease: [0.22, 1, 0.36, 1] }}
            className="relative z-[220] flex h-[95vh] w-[98vw] lg:h-[90vh] lg:w-[92vw] flex-col overflow-hidden bg-white/70 backdrop-blur-[45px] shadow-[0_50px_120px_rgba(0,0,0,0.5),inset_0_1px_0_rgba(255,255,255,0.6)] rounded-[2.25rem] lg:rounded-[3rem] border border-white/80 will-change-gpu"
          >
            {/* Grain Overlay */}
            ...
            <header 
              className={`relative z-[240] flex shrink-0 items-center justify-between border-b transition-all duration-600 px-8 md:px-12 ${
                scrolled 
                  ? "bg-white/85 border-white/65 backdrop-blur-[30px] shadow-[0_8px_32px_rgba(0,0,0,0.03)] py-3 md:py-3.5" 
                  : "bg-transparent border-transparent pt-8 pb-4 md:pt-10 md:pb-5"
              }`}
              style={{ transitionTimingFunction: "cubic-bezier(0.16, 1, 0.3, 1)" }}
            >
              <div className="flex items-center gap-3.5 border-2 border-white rounded-full px-6 py-2.5 bg-white/45 backdrop-blur-xl shadow-[0_12px_40px_rgba(0,0,0,0.04),inset_0_1px_3px_rgba(255,255,255,0.6)]">
                <img src={logo} className="w-8 h-8 md:w-9 md:h-9 object-contain" alt="Athiraa Logo" />
                <div className="flex flex-col">
                  <span className="text-xs md:text-sm font-black tracking-[0.25em] text-brand-primary leading-none">
                    ATHIRAA
                  </span>
                  <span className="text-[7px] md:text-[8px] font-black tracking-[0.38em] text-brand-gold mt-1 leading-none uppercase">
                    CONSULTANTS
                  </span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-6">
                <div className="hidden rounded-full border border-black/5 bg-white/50 px-5 py-2 md:flex md:items-center md:gap-3 backdrop-blur-md shadow-sm">
                  <div className="relative h-1.5 w-1.5">
                    <span className="absolute inset-0 rounded-full bg-emerald-500 animate-ping opacity-75" />
                    <span className="relative block h-1.5 w-1.5 rounded-full bg-emerald-500" />
                  </div>
                  <span className="text-[9px] font-black uppercase tracking-[0.4em] text-brand-primary/50">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  transition={{ ease: [0.22, 1, 0.36, 1], duration: 0.30 }}
                  className="flex h-10 w-10 items-center justify-center rounded-2xl border border-black/10 bg-white text-brand-primary hover:border-brand-gold hover:text-brand-gold focus:outline-none"
                >
            ...
            <div ref={scrollRef} className="relative flex-1 overflow-y-auto scroll-smooth custom-scrollbar" data-lenis-prevent="true">
              {/* HERO SECTION */}
              <section className="relative min-h-[48vh] lg:min-h-[52vh] flex items-center overflow-hidden bg-[#0c0d12]">
                ...
                <div className="relative z-10 w-full px-8 py-10 md:px-16 lg:px-24">
                  <motion.div initial="hidden" animate="visible" variants={heroStagger} className="max-w-4xl">
                    <motion.div variants={heroFadeUp} className="inline-flex items-center gap-4 rounded-full border border-white/10 bg-white/5 px-5 py-2 text-[9px] font-black uppercase tracking-[0.5em] text-brand-gold backdrop-blur-xl">
                      <span className="h-1.5 w-1.5 rounded-full bg-brand-gold shadow-[0_0_10px_rgba(194,154,73,1)] animate-pulse" />
                    ...
                    <motion.h2
                      ...
                      variants={heroFadeUp}
                      className="mt-5 font-playfair text-3xl md:text-4xl lg:text-[3.25rem] font-black md:leading-[1.1] leading-[1.15] tracking-tight text-white"
                    >
                    ...
                    <motion.div variants={heroFadeUp} className="mt-8 flex flex-col gap-4 sm:flex-row">
                      <MagneticButton
                        href="#contact"
                        onClick={onClose}
                        className="inline-flex items-center justify-center rounded-full bg-brand-gold px-8 py-3 text-[9px] md:text-[9.5px] font-black uppercase tracking-[0.4em] text-black shadow-2xl"
                      >
                        Initiate Consultation
                      </MagneticButton>
                      <MagneticButton
                        onClick={() => scrollRef.current?.scrollTo({ top: 500, behavior: "smooth" })}
                        className="inline-flex items-center justify-center rounded-full border border-white/15 bg-white/5 px-8 py-3 text-[9px] md:text-[9.5px] font-black uppercase tracking-[0.4em] text-white backdrop-blur-xl"
                      >
                        Explore Disciplines
                      </MagneticButton>
                    </motion.div>
              ...
              {/* Advisory Context */}
              <section className="bg-white border-y border-black/5 px-8 py-20 md:px-16 lg:px-24">
                <div className="grid lg:grid-cols-2 gap-20 items-center transform-gpu">
                   <SectionTitle
                  ...
                  >
                    {["Private Client", "Institutional", "Execution", "Discretion"].map((item, i) => (
                      <div 
                        key={item} 
                        className="p-8 rounded-[2.25rem] bg-white border border-black/[0.04] flex flex-col items-center justify-center text-center group hover:border-brand-gold/25 hover:-translate-y-1 transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] shadow-[0_10px_30px_rgba(0,0,0,0.01)] hover:shadow-[0_20px_40px_rgba(15,46,42,0.02)]"
                      >
                        <span className="text-[10px] font-black text-brand-gold mb-2 opacity-50 group-hover:opacity-100 transition-opacity">0{i+1}</span>
                        <span className="text-[11px] font-black uppercase tracking-[0.3em] text-brand-primary">{item}</span>
                      </div>
                    ))}
                  </motion.div>
                </div>
              ...
              {/* Spectrum */}
              <section className="bg-[#f9f8f4] px-8 py-20 md:px-16 lg:px-24 lg:py-28">
                <SectionTitle
                ...
                <div className="mt-16 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3 transform-gpu">
                  {services.map((service, idx) => (
                    <motion.article
                      ...
                      whileInView={{ opacity: 1, y: 0 }}
                      viewport={{ once: false, amount: 0.6, margin: "-50px" }}
                      transition={{ duration: 0.30, delay: idx * 0.05, ease: [0.22, 1, 0.36, 1] }}
                      className="group relative overflow-hidden rounded-[2.25rem] border border-black/[0.04] bg-white shadow-[0_15px_45px_rgba(0,0,0,0.02)] hover:shadow-[0_30px_60px_rgba(15,46,42,0.04)] hover:border-brand-gold/25 hover:-translate-y-1.5 transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] will-change-gpu"
                    >
                      <div className="relative h-48 md:h-52 overflow-hidden">
                        ...
                        <div className="absolute left-6 top-6">
                          <span className="rounded-full border border-white/20 bg-black/40 px-3 py-1 text-[7.5px] font-black uppercase tracking-[0.4em] text-white backdrop-blur-md">
                            {service.badge}
                          </span>
                        </div>
                        <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
                          <span className="text-[8px] font-black uppercase tracking-[0.5em] text-brand-gold mb-1.5 block">{service.category}</span>
                          <h4 className="text-base md:text-[17px] font-playfair font-black leading-tight text-white">{service.title}</h4>
                        </div>
                      </div>
                      <div className="p-6 md:p-8">
                        <p className="text-sm lg:text-[12px] leading-relaxed text-brand-primary/60 font-light">{service.desc}</p>
                        <div className="mt-5 flex flex-wrap gap-1.5">
                          {service.tags.map((tag) => (
                            <span key={tag} className="rounded-full border border-black/5 bg-brand-light px-2.5 py-1 text-[8px] md:text-[8.5px] font-black uppercase tracking-[0.2em] text-brand-primary/40 group-hover:border-brand-gold/20 group-hover:text-brand-primary/70 transition-all">
                              {tag}
                            </span>
                          ))}
                        </div>
              ...
              {/* Assurance Strip */}
              <section className="bg-brand-primary py-12 px-6 md:px-12 lg:px-16 lg:px-24 relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
                  <div className="text-center lg:text-left">
                    ...
                    <h3 className="text-white font-playfair text-lg md:text-xl font-light italic opacity-90">Adhering to Indian Institutional Frameworks</h3>
                  </div>
                  <div className="flex flex-wrap justify-center gap-3.5">
                    {["SEBI Facilitated", "RBI Aligned", "RERA Verified", "IT Act 1961"].map((item) => (
                      <span key={item} className="px-4 py-2 rounded-full border border-white/10 bg-white/5 text-[8px] md:text-[8.5px] font-black uppercase tracking-[0.4em] text-white/50 backdrop-blur-xl">
                        {item}
                      </span>
                    ))}
                  </div>
              ...
              {/* preservations */}
              <section className="bg-white px-8 py-20 md:px-16 lg:px-24 lg:py-28">
                <div className="grid gap-20 lg:grid-cols-2 items-center transform-gpu">
                  <motion.div
                    initial={{ opacity: 0, y: 25 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: false, amount: 0.6, margin: "-50px" }}
                    transition={{ duration: 0.30, ease: [0.22, 1, 0.36, 1] }}
                    className="relative rounded-[2.25rem] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.03)] will-change-gpu"
                  >
                    <img src={tax2} alt="Sophisticated Frameworks for Wealth Preservation and Tax Planning" className="w-full h-[24rem] md:h-[26rem] object-cover" />
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-10 md:p-12">
                       <span className="text-brand-gold text-[8px] font-black uppercase tracking-[0.6em] mb-3 block">Structuring Principle</span>
                       <h3 className="text-white text-2xl md:text-3xl lg:text-[2rem] font-playfair font-black leading-tight max-w-sm">
                    ...
                    <div className="mt-8 grid gap-4 sm:grid-cols-2 transform-gpu">
                      {[
                        ...
                        <motion.div 
                          ...
                          viewport={{ once: false, amount: 0.6, margin: "-50px" }}
                          transition={{ duration: 0.30, ease: [0.22, 1, 0.36, 1] }}
                          className="p-6 md:p-7 rounded-[2.25rem] border border-black/[0.04] bg-white shadow-[0_15px_45px_rgba(0,0,0,0.02)] hover:shadow-[0_30px_60px_rgba(15,46,42,0.04)] hover:border-brand-gold/25 hover:-translate-y-1 transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] will-change-gpu"
                        >
                          <h4 className="text-[14px] md:text-base font-black text-brand-primary mb-1.5">{item.title}</h4>
                          <p className="text-sm md:text-[11.5px] leading-relaxed text-brand-primary/50 font-light">{item.text}</p>
                        </motion.div>
                      ))}
                    </div>
                  </div>
                 ...
                 >
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mt-10">
                       <MagneticButton
                        href="#contact"
                        onClick={onClose}
                        className="w-full sm:w-auto px-10 py-4 rounded-full bg-white text-black font-black uppercase tracking-[0.5em] text-[9px] md:text-[9.5px] hover:bg-brand-gold hover:text-white transition-all shadow-2xl"
                      >
