  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center text-center px-4 max-w-4xl">
        <div className="w-[44vw] xs:w-[46vw] sm:w-[25vw] md:w-[19vw] lg:w-[14vw] max-w-[220px] min-w-[130px] mb-3">
          <video
            ref={videoRef}
        ...
        <div className="animate-fade-in-up opacity-0 [animation-delay:0.2s] flex flex-col items-center w-full">
          <p className="text-[15.5px] xs:text-[18px] sm:text-2xl md:text-3xl lg:text-4xl font-montserrat font-bold text-brand-primary tracking-[0.24em] leading-[1.3] mb-2 text-center whitespace-nowrap">
            ATHIRAA CONSULTANTS
          </p>

          <div className="flex items-center justify-center mb-2.5 gap-2 sm:gap-[10px]">
          ...
          <p className="text-[10px] xs:text-[11.5px] sm:text-[14px] md:text-base tracking-[0.22em] text-brand-muted font-medium uppercase font-montserrat text-center whitespace-nowrap">
