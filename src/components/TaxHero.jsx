            ...
            >
              ...
              <div className="hidden lg:flex flex-col sm:flex-row gap-3 sm:gap-6 xl:gap-8">
                ...
                <motion.a 
                  ...
                  whileTap={{ scale: 0.95 }}
                  href="#contact" 
                  className="inline-block text-center px-6 py-2.5 sm:px-9 sm:py-4 border border-white/20 text-white text-[10px] md:text-[11px] tracking-[0.4em] uppercase rounded-full font-black hover:bg-white/10 hover:border-white transition-all duration-500 backdrop-blur-md magnetic"
                >
                  Book a Consultation
                </motion.a>
              </div>
