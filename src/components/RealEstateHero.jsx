...
import realEstateVid from '../assets/videos/realestate.mp4';
import realEstateVidWebm from '../assets/videos/realestate.webm';
import realEstatePoster from '../assets/images/posters/realestate.webp';
...
const RealEstateHero = () => {
  ...
  return (
    <section ref={containerRef} id="real-estate-hero" className="relative min-h-[100dvh] lg:min-h-[105vh] lg:h-[105vh] w-full flex items-center overflow-hidden bg-black scroll-mt-0">
      ...
      >
        <LazyVideo className="w-full h-full object-cover opacity-50" src={realEstateVid} webmSrc={realEstateVidWebm} poster={realEstatePoster} />
      ...
      <div className="relative z-20 container mx-auto max-w-[1440px] px-6 md:px-12 lg:px-16 w-full min-h-[100dvh] lg:min-h-[105vh] lg:h-[105vh] flex flex-col pt-20 lg:pt-28 pb-16 xs:pb-20 sm:pb-24 lg:pb-8 justify-center">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between gap-8 lg:gap-12 w-full">
            ...
            >
              <div className="flex items-center gap-6 mb-3 sm:mb-4 lg:mb-6">
                <p className="text-[10px] tracking-[0.7em] uppercase text-brand-gold font-black">Real Estate</p>
              ...
              <p className="text-base md:text-lg font-light text-white/70 leading-relaxed max-w-xl mb-4 sm:mb-6 lg:mb-8">
                Complete real estate solutions — from buying and selling to rental management and investment advisory — helping you make confident property decisions.
              </p>
            ...
            <div className="w-full lg:w-[45%] flex flex-col gap-4 lg:gap-6 perspective-1000">
              {[
                { title: "Residential", id: "01", text: "Expert guidance for buying, selling, and investing in homes, apartments, and residential properties." },
                { title: "Commercial", id: "02", text: "End-to-end management and investment guidance for offices, retail spaces, and commercial properties." },
                { title: "Industrial", id: "03", text: "From warehouses to industrial parks — data-driven decisions for long-term property investments." }
              ].map((card) => (
                <motion.div 
                  key={card.id}
        ...
        >
          <p className="text-[10px] tracking-[0.6em] uppercase text-white/20 font-black">
            Residential • Commercial • Industrial • Investment Advisory
          </p>
        </motion.div>
      </div>
    </section>
